...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/19 15:26:44 by isallali          #+#    #+#             */
/*   Updated: 2025/05/19 17:43:11 by isallali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_args(int ac, char **av)
{
	...
	while (++i < ac)
	{
		if (!is_number(av[i]))
		{
			printf("Error: Arguments accept only positive numbers\n");
			return (1);
		}
	}
	return (0);
...
int	prog_args_init(t_prog *prog, int ac, char **av)
{
	...
	{
		printf("Error: Invalid arguments (accept only positive numbers)\n");
		return (1);
	}
	return (0);
}
