...
typedef struct s_simulation
{
    ...
    int				meals_required;
    pthread_mutex_t	write_and_meal_mutexes[2]; // [0] ensures that only one thread writes to the output at a time, [1] synchronize access to shared meal-related data (meal counts, simulation stop..)
